...
View::draw(ge211::Sprite_set& set)
{
   ...
   // std::cout << model_.dots_eaten();
    ...
    // if Pacman is moving, load the sound effect file and play the sound effect
    if (model_.pacman().velocity.width != 0 || model_.pacman().velocity.height != 0) {
